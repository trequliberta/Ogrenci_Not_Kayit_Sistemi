...
namespace Not_Kayit_Sistemii
{
    public partial class OgretmenDetay : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'dtbNotKayitDataSet.TBLDERS' table. You can move, or remove it, as needed.
            this.tBLDERSTableAdapter.Fill(this.dtbNotKayitDataSet.TBLDERS);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            lblgs.Text = GecenS.ToString();

            lblks.Text = KalanS.ToString();
